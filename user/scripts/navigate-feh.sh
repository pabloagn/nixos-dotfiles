...
# Remove the target file from the arguments, leaving any eventual arguments to feh.
shift

# Change to the directory and launch feh with the target file as the first argument, and the rest of the files in their normal order.
cd "$_dpath"
